...
def train(net, train_dataloader, validate_dataloader, subject, epochs=5500):
    ...
    writer.close()
    print('saving model')
    torch.save(net, 'save_net/mul_net_' + str(subject) + '.pt')
...
def main():
    ...
    for i in range(1, 10):
        ...
        for j in range(num):
            ...
            train(dsccnet, trainloader, validateloader, i)
